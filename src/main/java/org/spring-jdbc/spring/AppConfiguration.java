package org.spring-jdbc.spring;
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.spring-jdbc");
                servletContext.setInitParameter("tapestry.development-modules", "org.spring-jdbc.services.DevelopmentModule");
